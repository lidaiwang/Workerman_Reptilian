...
//        include "./class.smtp.php";
        ...
        $mail->Helo= "lidaiwangtime";
        $mail->setFrom("lidaiwangtime@163.com","lidaiwangtime");// 设置发件人信息，如邮件格式说明中的发件人，这里会显示为Mailer(xxxx@163.com），Mailer是当做名字显示
        $mail->addAddress($emailAddress,'lidaiwang');// 设置收件人信息，如邮件格式说明中的收件人，这里会显示为Liang(yyyy@163.com)
        $mail->IsHTML(true);
